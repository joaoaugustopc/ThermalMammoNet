...
if __name__ == "__main__":
    ...
    for i in range(5):
        comparar_modelos_por_id_com_consistencia(
                ...
                exp2_base=f"Resultados_tags_fixadas_corrigido_17_11/CAM_results",
                exp2_modelo=f"Vgg_AUG_CV_tam_marcadores_fixados_16_11_Corrigido_F{i}",
                output_dir=f"relatorio_tags_fixas/F{i}",
            )
