...
###### Para treinar UNET com imagens retangulares (160, 224), recortadas e GrayPadding(letterBOX)########


    # imgs_train, imgs_valid, masks_train, masks_valid = load_imgs_masks_sem_padding("Frontal", "Termografias_Dataset_Segmentação/images", "Termografias_Dataset_Segmentação/masks", True, True, 224)
    ...
    # with open("modelos/random_seed.txt", "a") as f:
    #     f.write(f"Valor da semente para treinar UNET com imagem retangular (168, 224): {VALUE_SEED}\n")
                
    # seed = random.randint(0,15000)  
                
    # tf.keras.utils.set_random_seed(seed)

    # model = unet_model_retangular()

    # model.summary()

    # earlystop = tf.keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.01, patience=50, verbose=1, mode='auto')

    # checkpoint = tf.keras.callbacks.ModelCheckpoint("modelos/unet/Frontal_Unet_AUG_Retangular.h5", monitor='val_loss', verbose=1, save_best_only=True, 
    #                                                         save_weights_only=False, mode='auto')
    ...
    # plt.legend()
    # plt.grid(True)
    # plt.savefig(f"unet_loss_convergence_Frontal_Unet_AUG_Retangular.png")
    # plt.close()
    ...
    # plt.legend()
    # plt.grid(True)
    # plt.savefig(f"unet_val_loss_convergence_Frontal_Unet_AUG_Retangular.png")
    # plt.close()

    # -------------------------------------------------------------------------------------#

    # imgs_train, imgs_valid, masks_train, masks_valid = load_imgs_masks_recortado("Frontal", "Termografias_Dataset_Segmentação/images", "Termografias_Dataset_Segmentação/masks", True, True, 224)
    ...
    # print(f"Valor da semente: {VALUE_SEED}")
    # with open("modelos/random_seed.txt", "a") as f:
    #     f.write(f"Valor da semente para treinar UNET com imagem recortada: {VALUE_SEED}\n")
    ...
    # checkpoint = tf.keras.callbacks.ModelCheckpoint("modelos/unet/Frontal_Unet_AUG_Recortada.h5", monitor='val_loss', verbose=1, save_best_only=True, 
    #                                                         save_weights_only=False, mode='auto')
    ...
    # plt.legend()
    # plt.grid(True)
    # plt.savefig(f"unet_loss_convergence_Frontal_Unet_AUG_Recortada.png")
    # plt.close()
    ...
    # plt.legend()
    # plt.grid(True)
    # plt.savefig(f"unet_val_loss_convergence_Frontal_Unet_AUG_Recortada.png")
    # plt.close()
    ...
    ####### Treinamento da ResNet34 com essas variações de redimensionamento #######
    ...
    # train_model_cv_retangular(ResNet34_retangular,
    ...
    #                seed= semente,
    #                segmenter="unet",
    #                message="ResNet_unet_AUG_CV_Retangular", seg_model_path="modelos/unet/Frontal_Unet_AUG_Retangular.h5")
    
    # train_model_cv_recortado(ResNet34,
    #                raw_root="filtered_raw_dataset",
    #                angle="Frontal",
    #                k=5,                 
    #                resize_to=224,
    ...
    #                seed= semente,
    #                segmenter="unet",
    #                message="ResNet_unet_AUG_CV_Recortado", seg_model_path="modelos/unet/Frontal_Unet_AUG_Recortada.h5")
    ...
    #                seed= semente,
    #                segmenter="unet",
    #                message="ResNet_unet_AUG_CV_GrayPadding", seg_model_path="modelos/unet/Frontal_Unet_AUG_CV_GrayPadding.h5")
    # train_model_cv_retangular(ResNet34_retangular,
    #                raw_root="filtered_raw_dataset",
    #                angle="Frontal",
    #                k=5,                 
    ...
    #                batch=8,
    #                seed= semente,
    #                message="ResNet_AUG_CV_Retangular")
    # train_model_cv_recortado(ResNet34,
    #                raw_root="filtered_raw_dataset",
    #                angle="Frontal",
    #                k=5,                 
    ...
    #                batch=8,
    #                seed= semente,
    #                message="ResNet_AUG_CV_Recortado")
    # train_model_cv(ResNet34,
    #                raw_root="filtered_raw_dataset",
    #                angle="Frontal",
    #                k=5,                 
    ...
    #                batch=8,
    #                seed= semente,
    #                message="ResNet_AUG_CV_GrayPadding")
    ...
    ######## GEração dos Mapas de Calor (EIGEN CAM) para os modelos treinados com variações de redimensionamento ##########
    ...
    #     X_test = ppeprocessEigenCam(X, y, f"splits/ResNet_unet_AUG_CV_GrayPadding_Frontal_F{i}.json", segment="unet", segmenter_path="modelos/unet/Frontal_Unet_AUG_CV_GrayPadding.h5")
        

    #     run_eigencam(
    #         imgs       = X_test,
    #         model_path = f"modelos/ResNet34/ResNet_unet_AUG_CV_GrayPadding_Frontal_F{i}.h5",
    #         out_dir    = f"CAM_results_ResNet_unet_AUG_GrayPadding_F{i}"
    #     )

    # for i in range(5):

    #     X_test = ppeprocessEigenCam(X, y, f"splits/ResNet_AUG_CV_GrayPadding_Frontal_F{i}.json")
        

    #     run_eigencam(
    #         imgs       = X_test,
    #         model_path = f"modelos/ResNet34/ResNet_AUG_CV_GrayPadding_Frontal_F{i}.h5",
    #         out_dir    = f"CAM_results_ResNet_AUG_GrayPadding_F{i}"
    #     )
